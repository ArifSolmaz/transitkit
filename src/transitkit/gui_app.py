...
class TransitKitGUI(tk.Tk):
    ...
    def _build_manual_tab(self):
        ...
        # Title
        title_label = ttk.Label(manual_frame, text="TransitKit v2.0 - Complete User Manual", 
        ...
        self.manual_text = tk.Text(text_frame, wrap=tk.WORD, font=("Consolas", 10),
        ...
        self.manual_text.tag_configure("h1", font=("Helvetica", 14, "bold"), spacing1=15, spacing3=5)
        self.manual_text.tag_configure("h2", font=("Helvetica", 12, "bold"), spacing1=10, spacing3=3)
        self.manual_text.tag_configure("h3", font=("Helvetica", 11, "bold italic"), spacing1=8, spacing3=2)
...
'''
    ...
    def on_sim_bls(self):
        ...
        def worker():
            try:
                res = find_transits_bls_advanced(self.sim_time, self.sim_flux, 
                                       min_period=0.5, max_period=20.0, n_periods=5000,
                                       n_bootstrap_fap=0)  # Faster for interactive use
                
                periods = res.get("all_periods")
                y = res["all_powers"] if ("all_powers" in res and res["all_powers"] is not None) else res.get("all_scores")
    ...
    def on_tess_bls(self):
        ...
        def work():
            try:
                res = find_transits_bls_advanced(self.tess_time, self.tess_flux, min_period=minP, max_period=maxP, n_periods=nper, n_bootstrap_fap=0)

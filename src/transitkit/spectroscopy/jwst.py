...
class JWSTSpectroscopy:
    ...
    def get_transmission_spectrum(
        self, instrument: Optional[str] = None, program_id: Optional[str] = None
            ...
            for row in jwst_obs:
                ...
                try:
                    ...
                    x1d = Observations.filter_products(
                        products, productSubGroupDescription=["X1D", "X1DINTS"]
                    )
    ...
    def detect_molecules(
        self, spectrum: Optional[TransmissionSpectrum] = None, sigma_threshold: float = 3.0
    ...
    def _fit_with_petitradtrans(
        self, spectrum: TransmissionSpectrum, molecules: Optional[List[str]] = None
    ) -> AtmosphericProperties:
    ...
    def _simple_analysis(
        self, spectrum: TransmissionSpectrum, props: AtmosphericProperties
    ) -> AtmosphericProperties:
    ...
    def plot_spectrum(
        ...
        ax.errorbar(
            ...
            yerr=(
                ...
                if np.nanmedian(spectrum.transit_depth_err) < 0.1
        ...
        ax.set_title(
            f"{spectrum.planet_name} Transmission Spectrum\n{spectrum.instrument}", fontsize=14
        )
